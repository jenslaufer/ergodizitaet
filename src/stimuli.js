...
export function tagStimuli(tag, dynamik, idx = mische([0, 1, 2, 3, 4, 5, 6, 7, 8])) {
  ...
  return werte.map((w, i) => ({
    wert: w,
    bild: muster(idx[i] + tag * 9, FARBEN[idx[i]]),
  }));
}
